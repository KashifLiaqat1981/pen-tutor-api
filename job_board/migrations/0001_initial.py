    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teaching_mode', models.CharField(choices=[('remote', 'Remote'), ('in person', 'In Person')], default='remote', max_length=10)),
                ...
                ('duration_unit', models.CharField(choices=[('hour', 'Hour'), ('day', 'Day'), ('week', 'Week'), ('month', 'Month')], default='hours', help_text='e.g., hours, days, sessions', max_length=20)),
                ('additional_notes', models.TextField(blank=True)),
                ('location', models.CharField(blank=True, help_text='Required for physical teaching mode', max_length=200)),
                ('time_to_study', models.TimeField(blank=True, help_text='Preferred study time', null=True)),
                ('days_to_study', models.CharField(blank=True, help_text='Comma-separated list of days e.g. monday,tuesday', max_length=200)),
